...
class SchoolApiController extends Controller
{
    public function index()
    {
        ...
        return new SchoolResource(School::with(['gender_type', 'category', 'ward', 'principal', 'registered_by', 'approved_by'])->get());
    }
    ...
    public function show(School $school)
    {
        ...
        return new SchoolResource($school->load(['gender_type', 'category', 'ward', 'principal', 'registered_by', 'approved_by']));
    }
