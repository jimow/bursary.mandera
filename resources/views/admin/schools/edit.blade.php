    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.schools.update", [$school->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('gender_type') ? 'is-invalid' : '' }}" name="gender_type_id" id="gender_type_id" required>
                    @foreach($gender_types as $id => $entry)
                        <option value="{{ $id }}" {{ (old('gender_type_id') ? old('gender_type_id') : $school->gender_type->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('category') ? 'is-invalid' : '' }}" name="category_id" id="category_id" required>
                    @foreach($categories as $id => $entry)
                        <option value="{{ $id }}" {{ (old('category_id') ? old('category_id') : $school->category->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('ward') ? 'is-invalid' : '' }}" name="ward_id" id="ward_id" required>
                    @foreach($wards as $id => $entry)
                        <option value="{{ $id }}" {{ (old('ward_id') ? old('ward_id') : $school->ward->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('ward'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('principal') ? 'is-invalid' : '' }}" name="principal_id" id="principal_id">
                    @foreach($principals as $id => $entry)
                        <option value="{{ $id }}" {{ (old('principal_id') ? old('principal_id') : $school->principal->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone_number') ? 'is-invalid' : '' }}" type="text" name="phone_number" id="phone_number" value="{{ old('phone_number', $school->phone_number) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('postal_address') ? 'is-invalid' : '' }}" type="text" name="postal_address" id="postal_address" value="{{ old('postal_address', $school->postal_address) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('physical_address') ? 'is-invalid' : '' }}" type="text" name="physical_address" id="physical_address" value="{{ old('physical_address', $school->physical_address) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('physical_location') ? 'is-invalid' : '' }}" type="text" name="physical_location" id="physical_location" value="{{ old('physical_location', $school->physical_location) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('code') ? 'is-invalid' : '' }}" type="text" name="code" id="code" value="{{ old('code', $school->code) }}" required>
                @if($errors->has('code'))
                    <div class="invalid-feedback">
                        {{ $errors->first('code') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('registered_by') ? 'is-invalid' : '' }}" name="registered_by_id" id="registered_by_id">
                    @foreach($registered_bies as $id => $entry)
                        <option value="{{ $id }}" {{ (old('registered_by_id') ? old('registered_by_id') : $school->registered_by->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('approved_by') ? 'is-invalid' : '' }}" name="approved_by_id" id="approved_by_id">
                    @foreach($approved_bies as $id => $entry)
                        <option value="{{ $id }}" {{ (old('approved_by_id') ? old('approved_by_id') : $school->approved_by->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fees') ? 'is-invalid' : '' }}" type="text" name="fees" id="fees" value="{{ old('fees', $school->fees) }}">
                @if($errors->has('fees'))
                    <div class="invalid-feedback">
                        {{ $errors->first('fees') }}
                    </div>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\School::UNIFORM_FEE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('uniform_fee') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="uniform_fee_{{ $key }}" name="uniform_fee" value="{{ $key }}" {{ old('uniform_fee', $school->uniform_fee) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('f_1_fee') ? 'is-invalid' : '' }}" type="number" name="f_1_fee" id="f_1_fee" value="{{ old('f_1_fee', $school->f_1_fee) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('f_2_fee') ? 'is-invalid' : '' }}" type="text" name="f_2_fee" id="f_2_fee" value="{{ old('f_2_fee', $school->f_2_fee) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('f_3_fee') ? 'is-invalid' : '' }}" type="number" name="f_3_fee" id="f_3_fee" value="{{ old('f_3_fee', $school->f_3_fee) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('f_4_fee') ? 'is-invalid' : '' }}" type="number" name="f_4_fee" id="f_4_fee" value="{{ old('f_4_fee', $school->f_4_fee) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('b_1_fee') ? 'is-invalid' : '' }}" type="number" name="b_1_fee" id="b_1_fee" value="{{ old('b_1_fee', $school->b_1_fee) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('b_2_fee') ? 'is-invalid' : '' }}" type="number" name="b_2_fee" id="b_2_fee" value="{{ old('b_2_fee', $school->b_2_fee) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('b_3_fee') ? 'is-invalid' : '' }}" type="text" name="b_3_fee" id="b_3_fee" value="{{ old('b_3_fee', $school->b_3_fee) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('b_4_fee') ? 'is-invalid' : '' }}" type="text" name="b_4_fee" id="b_4_fee" value="{{ old('b_4_fee', $school->b_4_fee) }}">
