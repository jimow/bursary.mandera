...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.otherSetting.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.other-settings.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fees_percentage') ? 'is-invalid' : '' }}" type="text" name="fees_percentage" id="fees_percentage" value="{{ old('fees_percentage', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('term_1') ? 'is-invalid' : '' }}" type="text" name="term_1" id="term_1" value="{{ old('term_1', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('term_2') ? 'is-invalid' : '' }}" type="text" name="term_2" id="term_2" value="{{ old('term_2', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('term_3') ? 'is-invalid' : '' }}" type="text" name="term_3" id="term_3" value="{{ old('term_3', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('day_fees_percentage') ? 'is-invalid' : '' }}" type="text" name="day_fees_percentage" id="day_fees_percentage" value="{{ old('day_fees_percentage', '') }}">
